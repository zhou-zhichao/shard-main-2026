...
namespace Shard
{
    class Bootstrap
    {
        ...
        public static void setup()
        {
            ...
            while (!File.Exists(Path.Combine(workDir, "envar.cfg")) && Directory.GetParent(workDir) != null)
            {
            ...
            if (!File.Exists(Path.Combine(baseDir, "envar.cfg")))
            {
                 Console.WriteLine("Critical Error: Could not find envar.cfg in parent directories.");
            }
